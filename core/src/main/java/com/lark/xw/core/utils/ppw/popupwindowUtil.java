package com.lark.xw.core.utils.ppw;
 ...
 * 封装的PopupWidow的工具类
 *
 * @author hf  2016-09-09 13:31
 * @version 1.0
 * @des
 * @版本 $Rev$
 * @change $Author$  $Date$
 * @des 直接new完传递参数，实现方法，通过builder调用方法，可以自己扩展
 */
public class popupwindowUtil {
    ...
    public static popupwindowUtil create() {
     ...
     */
    public void showPPw(Context context, int layoutResId, int width, int height, View parentView, int gravity, int x, int y, ClickListener callback) {
        ...
        PopBuilder builder = PopBuilder.createPopupWindow(mContext, mlayoutResId, mwidth, mHeight, parentView, gravity, x, y, mCallback);
    }
    ...
    public static class PopBuilder {
        ...
        private static PopBuilder createPopupWindow(final Context context, int layoutResId, int width, int height, View parent, int gravity, int x, int y, ClickListener callback) {
